...
function __wbg_adapter_24(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hdf8936c73d7478b1(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {Promise<any>}
*/
export function autofill_form(pass) {
    const ptr0 = passStringToWasm0(pass, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
export function fill_table(pass) {
    const ptr0 = passStringToWasm0(pass, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.fill_table(ptr0, len0);
    return takeObject(ret);
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('servicenow_bug_tracker_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
